...
* **playwright** (MCP: `playwright_navigate`, `playwright_click`, etc.) para
...
4. **Atualizar documentação (Gate D)**
   ...
   * Marcar status da tarefa em `tasks.md`; **ao concluir, marcar como “concluída”**.
...
* [ ] `tasks.md` atualizado (status, dependências, `_Requirements:` corretos; **tarefa marcada como “concluída” quando finalizada**)
